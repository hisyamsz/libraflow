...
function SidebarProvider({
  ...
  const toggleGlobalSidebar = useSidebarStore((state) => state.toggleSidebar);
  ...
  const open = openProp ?? (mounted ? !isCollapsed : defaultOpen);
  ...
  const toggleSidebar = React.useCallback(() => {
    return isMobile ? setOpenMobile((open) => !open) : toggleGlobalSidebar();
  }, [isMobile, toggleGlobalSidebar]);
